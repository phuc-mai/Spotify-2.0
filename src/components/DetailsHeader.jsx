          ...
          src={
            artistId
              ? artistData?.attributes?.artwork?.url
                  .replace("{w}", "500")
                  .replace("{h}", "500")
              : songData?.resources["shazam-songs"][songId]["attributes"]["images"]["coverArt"]
          }
        ...
        <div className="ml-5">
          <p className="font-bold sm:text-3xl text-xl text-white">
            {artistId
              ...
              : songData.resources["shazam-songs"][songId]["attributes"]["title"]
            }
          </p>
          ...
          <p className="text-base text-gray-400 mt-2">
            {artistId
              ...
              : songData.resources["shazam-songs"][songId]["attributes"]["genres"]["primary"]
            }
          </p>
        </div>
      </div>
